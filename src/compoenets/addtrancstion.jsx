...
const QuickAddTransaction = ({ onAdd, show, handleClose, id = "", update }) => {
  ...
  useEffect(() => {
    ...
    if (id) {
      const edit = userTransactions.find((i) => i.id == id)
      ...
      <Modal.Body>
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-lg font-semibold text-gray-900"> {id?"Edit ":"Add "}Transaction</h3>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border min-h-[100px] border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
